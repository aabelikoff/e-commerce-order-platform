...
import { CreatePaginatedType } from '../../types/creat-paginated.type';
...
@ObjectType({
  description: 'Paginated list of orders following the Connection pattern',
})
export class OrdersConnection extends CreatePaginatedType(OrderModel, false) {}
